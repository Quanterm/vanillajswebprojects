...
NOTE ON PULL REQUESTS: All of these projects are part of the course. While [they] (https://github.com/bradtraversy/vanillawebprojects) do appreciate people trying to make some things prettier or adding new features, we are only accepting pull requests and looking at issues for bug fixes so that the code stays inline with the course
